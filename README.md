...
> **Version:** 1.11.1 · **Stack:** Next.js 16, React 19, TypeScript, Tailwind CSS 4, Node 24 (`node:sqlite`)
...
| `APP_VERSION` | | `1.11.1` | Version baked into the image. Visible in the `/api/health` response and the UI. |
