...
> **Sürüm:** 1.11.0 · **Yığın:** Next.js 16, React 19, TypeScript, Tailwind CSS 4, Node 24 (`node:sqlite`)
...
| `APP_VERSION` | | `1.11.0` | İmaja gömülen sürüm. `/api/health` yanıtında ve arayüzde görünür. |
